...
# Test variant: original deeprobotics rsl_rl (AMPOnPolicyRunner + AsymActorCritic)
# Use this to isolate environment bugs from rsl_rl bugs.
gym.register(
    id="Amp-Flat-DR-RSL-CR1-v0",
    entry_point="rl_training.envs:AmpLocomotionEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.flat_env_cfg:CR1AmpFlatEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.deeprobotics_amp_cfg:CR1DeepRoboticsAmpRunnerCfg",
    },
)
