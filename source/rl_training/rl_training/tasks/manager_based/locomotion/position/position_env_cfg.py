...
class RewardsCfg:
    ...
    stand_still_without_cmd_wheel = RewTerm(
        func=mdp.stand_still_without_cmd_wheel,
        weight=0.0,
        params={
            "command_name": "base_velocity",
            "command_threshold": 0.05,
            "asset_cfg": SceneEntityCfg("robot", joint_names=""),
            "action_term_name": "joint_vel",
        },
    )
    ...
    hipy_joint_pos_penalty_no_ang_z = RewTerm(
        func=mdp.joint_pos_penalty_no_ang_z,
        weight=0.0,
        params={
            "command_name": "base_velocity",
            "asset_cfg": SceneEntityCfg("robot", joint_names=".*"),
    ...
    knee_joint_pos_penalty_no_ang_z = RewTerm(
        func=mdp.joint_pos_penalty_no_ang_z,
        weight=0.0,
        params={
            "command_name": "base_velocity",
    ...
    hipy_joint_pos_penalty_only_ang_z = RewTerm(
        func=mdp.joint_pos_penalty_only_ang_z,
        weight=0.0,
        params={
            "command_name": "base_velocity",
            "asset_cfg": SceneEntityCfg("robot", joint_names=".*"),
    ...
    knee_joint_pos_penalty_only_ang_z = RewTerm(
        func=mdp.joint_pos_penalty_only_ang_z,
        weight=0.0,
        params={
            "command_name": "base_velocity",
    ...
    feet_air_time_lin_y = RewTerm(
        func=mdp.feet_air_time_lin_y_cmd,
        weight=0.0,
        params={
            "command_name": "base_velocity",
            "threshold": 0.5,
    ...
    phase_wheel_trajectory_exp = RewTerm(
        func=mdp.phase_wheel_trajectory_exp,
        weight=0.0,
        params={
            "command_name": "base_velocity",
            "asset_cfg": SceneEntityCfg("robot", body_names=".*_foot"),
    ...
    feet_air_time_turn_in_place = RewTerm(
        func=mdp.feet_air_time_turn_in_place_cmd,
        weight=0.0,
        params={
            "command_name": "base_velocity",
            "threshold": 0.5,
    ...
    feet_contact_turn_with_lin_x = RewTerm(
        func=mdp.feet_contact_turn_with_lin_x_cmd,
        weight=0.0,
        params={
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=""),
            "command_name": "base_velocity",
