...
from rl_training.tasks.manager_based.locomotion.position.position_env_cfg import (
    ActionsCfg,
...
class DeeproboticsM20RewardsCfg(RewardsCfg):
    ...
    action_rate_l2_wheel = RewTerm(
        func=mdp.action_rate_l2_wheel,
        weight=0.0,
        params={"action_term_name": "joint_vel"},
    )

    action_rate_l2_non_wheel = RewTerm(
        func=mdp.action_rate_l2_non_wheel,
        weight=0.0,
...
@configclass
class DeeproboticsM20RoughEnvCfg_DF(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # # # terrain proportions
        self.scene.terrain.terrain_generator.sub_terrains["flat"] = terrain_gen.MeshPlaneTerrainCfg(proportion=0.1)
        ...
        self.rewards.stand_still_without_cmd_wheel.weight = -0.5
        self.rewards.stand_still_without_cmd_wheel.params["asset_cfg"].joint_names = self.wheel_joint_names
        self.rewards.stand_still_without_cmd_wheel.params["action_term_name"] = "joint_vel"
        ...
        self.rewards.hipy_joint_pos_penalty.weight = -2.0
        ...
        # self.rewards.hipy_joint_pos_penalty_no_ang_z.weight = -1.0
        # self.rewards.hipy_joint_pos_penalty_no_ang_z.params["asset_cfg"].joint_names = self.hipy_joint_names
        # self.rewards.knee_joint_pos_penalty_no_ang_z.weight = -1.0
        # self.rewards.knee_joint_pos_penalty_no_ang_z.params["asset_cfg"].joint_names = self.knee_joint_names
        # self.rewards.hipy_joint_pos_penalty_only_ang_z.weight = -0.25
        # self.rewards.hipy_joint_pos_penalty_only_ang_z.params["asset_cfg"].joint_names = self.hipy_joint_names
        # self.rewards.knee_joint_pos_penalty_only_ang_z.weight = -0.25
        # self.rewards.knee_joint_pos_penalty_only_ang_z.params["asset_cfg"].joint_names = self.knee_joint_names
        ...
        self.rewards.action_rate_l2_wheel.weight = -0.01
        self.rewards.action_rate_l2_non_wheel.weight = -0.01
        ...
        self.rewards.track_lin_vel_xy_exp.weight = 5.0 # 1.8
        ...
        self.rewards.feet_air_time_turn_in_place.weight = 2.0
        self.rewards.feet_air_time_turn_in_place.params["sensor_cfg"].body_names = [self.foot_link_name]
        self.rewards.feet_air_time_lin_y.weight = 0.0
        self.rewards.feet_air_time_lin_y.params["sensor_cfg"].body_names = [self.foot_link_name]
        self.rewards.feet_contact_turn_with_lin_x.weight = 0.0
        self.rewards.feet_contact_turn_with_lin_x.params["sensor_cfg"].body_names = [self.foot_link_name]
        self.rewards.feet_stumble.weight = 0
        self.rewards.feet_stumble.params["sensor_cfg"].body_names = [self.foot_link_name]
        self.rewards.feet_slide.weight = 0
        self.rewards.feet_slide.params["sensor_cfg"].body_names = [self.foot_link_name]
        self.rewards.feet_slide.params["asset_cfg"].body_names = [self.foot_link_name]
        self.rewards.feet_slide_ang_z_cmd.weight = -10.0
        ...
        self.rewards.phase_wheel_trajectory_exp.weight = 0.0
        self.rewards.phase_wheel_trajectory_exp.params["asset_cfg"].body_names = [self.foot_link_name]

        # If the weight of rewards is 0, set rewards to None
        if self.__class__.__name__ == "DeeproboticsM20RoughEnvCfg_DF":
